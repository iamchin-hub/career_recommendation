"""Career-scan page for the Hakbang PH multipage Streamlit app."""
...
st.markdown(
    ...
    <style>
      ...
      .nav-pills a:hover,
      .nav-pills a.active {background: rgba(255,255,255,.07);}
      .nav-pills .nav-cta {
...
st.html(
    ...
    <div id="hakbang-navigation">
        <section class="hero">
          <div class="hero-copy">
            ...
            <div class="hero-actions">
              <a class="hero-primary" href="#career-scan">
                Start my career scan →
              </a>
              <a class="hero-secondary" href="/method" target="_self">
                See how it works
              </a>
            </div>
          </div>
        ...
        <section class="proof-strip">
          ...
          <div class="proof-chip">__PROFILE_COUNT__
            synthetic<br/>skill profiles</div>
          <div class="proof-chip">__CAREER_COUNT__ career<br/>pathways</div>
          <div class="proof-chip">__SKILL_COUNT__ transferable<br/>skill signals</div>
        </section>
    ...
    .replace(
        "__PROFILE_COUNT__",
        f"{SYNTHETIC_PROFILES_PER_CAREER * len(CAREERS):,}",
    )
    .replace("__CAREER_COUNT__", str(len(CAREERS)))
...
# Method and Evidence are registered as separate Streamlit pages by the
# multipage entrypoint. Stop this page here so neither section is appended below
# a career-scan result.
st.stop()
